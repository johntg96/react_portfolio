        ...
        <MDBRow>
          ...
          <MDBCol>
            <MDBContainer id='about-me-text' className='mt-4 mb-2 flex-wrap'>
              ...
              <p>Through my computer endeavors I've participated several team-focused development projects, one being a full-stack react application <em style={{ fontSize: "80%" }}>(MERN stack)</em>.</p>
            </MDBContainer>
          </MDBCol>
        </MDBRow>
        </MDBContainer>
